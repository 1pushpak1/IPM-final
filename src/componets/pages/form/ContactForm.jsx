            ...
            <form ref={formRef} onSubmit={sendEmail} className="contact-form ajax-contact">
                <div className="row">
                    ...
                    <div className="col-12">
                        <div className="form-group"><textarea name="message" id="message" cols="30" rows="1" className="form-control style-white" placeholder="Write Your Message*" required></textarea> <i className="fal fa-pen"></i></div>
                    </div>
