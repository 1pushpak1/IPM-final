                  ...
                  <div className="row align-items-center justify-content-center">
                     <div className="col-md-6">
                        <div className="hero-style1">
                           ...
                           <div className="btn-group" data-ani="slideinleft" data-ani-delay="0.8s"><a className="th-btn style3"><Link to="/contactus">Book a Counselling Session</Link><i className="fas fa-arrow-right ms-2"></i></a></div>
                        </div>
                     </div>
