         ...
         <div className="container">
            <div className="row align-items-center">
               <div className="col-xl-6">
                  <div className="img-box1 mb-40 mb-xl-0">
                     ...
                     <div className="about-grid" data-bg-src="assets/img/normal/about_1_3.png">
                        <h3 className="about-grid_year"><span className="counter-number">500</span><span className="text-theme">+</span></h3>
                        <p className="about-grid_text">Students Active Our Courses</p>
                     </div>
                     <div className="img2"><img className="tilt-active" src="assets/img/normal/att2.jpg" alt="About" /></div>
               ...
               <div className="col-xl-6">
                  ...
                  <div className="btn-group mt-40"><a href="#" className="th-btn">About More<i className="fa-regular fa-arrow-right ms-2"></i></a></div>
               </div>
            </div>
         </div>
      </div>
