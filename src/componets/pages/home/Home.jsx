            ...
            <div className="row align-items-center">
               <div className="col-xl-6">
                  <div className="img-box1 mb-40 mb-xl-0">
                     ...
                     <div className="about-grid" data-bg-src="assets/img/normal/att2.jpg">
                        <h3 className="about-grid_year"><span className="counter-number">200</span><span className="text-theme">+</span></h3>
