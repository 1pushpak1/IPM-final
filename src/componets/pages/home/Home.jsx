                  ...
                  <div className="th-carousel testi-slider1 dot-style2 row" id="testimonial-slider1" data-slide-show="2" data-ml-slide-show="2" data-lg-slide-show="1" data-md-slide-show="1" data-dots="true" data-arrows="false">
                     ...
                     <div className="col-lg-6">
                        <div className="testi-box">
                           ...
                           <div className="testi-box_content">
                              <p className="testi-box_text">“IPM Prime is the best online Mentorship platform for preparing for IPM-AT. The regular Sectional and Mock tests with detailed analysis and personalised plan helped me a lot to strengthen the concepts with clarity. I enhanced my question solving speed and accuracy with the help of mock tests and a unique approach to mock analysis which were provided. One-to-One sessions are wow as it never leaves you alone. IPM Prime Tutorial made IPM-AT prep easy and achievable. Heartfelt gratitude to IPM Prime for helping me get into an IIM.”</p>
                           </div>
                           <div className="testi-box_bottom">
                              <div>
         ...
         <section className="space-top space-extra2-bottom">
            <div className="container">
               <div className="title-area text-center mb-50">
                  ...
                  <h2 className="sec-title"> A directory of wonderful things</h2>
               </div></div>
            <div className="container">
               <div className="row">
                  <div className="col-xxl-9 col-lg-12">
                     <div className="course-single">
                        ...
                        <div className="course-single-bottom">
                           ...
                           <p>To prepare for the Verbal Ability section of the IPMAT (Integrated Program in Management - Aptitude Test), you need to focus on improving your reading, vocabulary, correct usage and comprehension skills. This section typically consists of questions related to reading comprehension, vocabulary, grammar, and sentence correction.  <Link to="/#">More</Link></p>
                        </div>
                     </div>
