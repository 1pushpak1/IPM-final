                                       ...
                                       <div className="col-md-6 col-lg-4">
                                          <div className="course-box">
                                             ...
                                             <div className="course-content">
                                                ...
                                                <div className="btn-group mt-40"><a href="https://www.primeacademy.app/login" className="th-btn">Free Mock Test<i className="fa-regular fa-arrow-right ms-2"></i></a><Link to="/testmod" className="th-btn">Enroll Now<i className="fa-regular fa-arrow-right ms-2"></i></Link></div>
                                             </div>
                                          </div>
                                       </div>
                                       <div className="col-md-6 col-lg-4">
