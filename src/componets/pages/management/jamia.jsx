        ...
        <div className="breadcumb-shape" data-bg-src="assets/img/bg/breadcumb_shape_1_1.png"></div>
         ...
         <div className="container">
            <div className="breadcumb-content text-center">
               <h1 className="breadcumb-title">Jamia Millia University</h1>
               <ul className="breadcumb-menu">
                  <li><a href="#">Explore Management</a></li>
                  <li>Jamia Millia University</li>
               </ul>
            </div>
         </div>
      </div>
         ...
         <div className="row align-items-center">
            <div className="col-xl-11">
               <div className="wcu-img-1">
                  <div className="img1"><img src="assets/img/normal/jamia.png" alt="img" /></div>
