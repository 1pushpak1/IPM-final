! function(t) {
    ...
    t(c).on("submit", (function(t) {
            t.preventDefault(), h()
        })), o = ".popup-search-box", r = ".searchClose", l = "show", t(".searchBoxToggler").on("click", (function(e) {
        ...
        function(e, a, s, i) {
            ...
            t(this).each((function() {
                var s, i, n, o, r, l = t(this);
                s = Math.floor(l.height() / 2), i = l.attr(e), n = l.attr(a), o = p(t(n).css("padding-top")), r = p(t(n).css("padding-bottom")), "top-half" === i ? (t(n).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px")) : "bottom-half" === i && (t(n).css("padding-top", o + s + "px"), l.css("margin-bottom", "-" + s + "px"))
            }))
        };
    ...
    t("[data-sec-pos]").length && t("[data-sec-pos]").imagesLoaded((function() {
        ...
        t(this).each((function() {
            ...
            function r() {
                ...
                i.get(0).style.setProperty("--height-set", o), i.get(0).style.setProperty("--width-set", r), i.get(0).style.setProperty("--pos-y", l), i.get(0).style.setProperty("--pos-x", c), t(s).first().position().left == n.position().left ? i.addClass("start").removeClass("center").removeClass("end") : t(s).last().position().left == n.position().left ? i.addClass("end").removeClass("center").removeClass("start") : i.addClass("center").removeClass("start").removeClass("end")
            }
            r()
        }))
    ...
    t.fn.lettering = function(e) {
        ...
        t(this).each((function() {
            ...
            var i = setInterval((function() {
                ...
                o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), l < 10 && (l = "0" + l), c < 10 && (c = "0" + c), n < 0 ? (clearInterval(i), e.addClass("expired"), e.find(".message").css("display", "block")) : (s(".day").html(o), s(".hour").html(r), s(".minute").html(l), s(".seconds").html(c))
            }), 1e3)
        }))
